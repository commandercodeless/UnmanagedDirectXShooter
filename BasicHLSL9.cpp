...
// Microsoft sample code.  This one loads a mesh, but it us using the		//
// Microsoft helper class CDXUTSDKMesh, as there is no longer any built in	//
...
//**************************************************************************//
// Direct3D9 resources for backwards compatability in case we can't make a	//
// DirectX11 rendering device.  We won't be using the backwards stuff.		//
//**************************************************************************//
